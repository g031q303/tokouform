...
if (!empty($_POST['btn_submit'])){
    ...
    if( empty($error_message) ) { 
     ...
     //データベース接続
   $mysqli = new mysqli( 'localhost', 'g031q303', 'j2vcPFbyqE', 'g031q303');
...
<body>
<form>
<input type="button" onClick="location.href='https://tkg-lab.tk/~g031q303/tokoudb/admin.php'" value="管理者画面へ">
</form>
<h1>トップページ</h1>
<!-- ここにメッセージの入力フォームを設置 -->
