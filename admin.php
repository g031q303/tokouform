...
define( 'DB_USER', 'g031q303');
define( 'DB_PASS', 'j2vcPFbyqE');
define( 'DB_NAME', 'g031q303');
...
<body>
<form>
<input type="button" onClick="location.href='https://tkg-lab.tk/~g031q303/tokoudb/index.php'" value="TOPページへ">
</form>
<h1>管理ページ</h1>
